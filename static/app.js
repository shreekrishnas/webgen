    ...
    <div>
      <div class="dash-hero reveal">
        <div>
          ...
          <p class="dash-hero-sub">Track speaker performance, audience engagement and outcomes across every webinar, all in one place.</p>
        </div>
...
function _renderTopicIntel(data) {
  ...
  const angleCards = [
    { title:'Customer Success Stories', icon:'🌟', why:'Showcasing real client outcomes builds trust and drives high-intent registrations.' },
    { title:'Industry Trends & Insights', icon:'📈', why:'Positioning your team as thought leaders attracts decision-makers actively seeking guidance.' },
    { title:'Advanced Strategy Workshop', icon:'🏦', why:'Deep-dive workshops attract high-value prospects looking for expert-level content.' },
    { title:'Getting Started Guide', icon:'📊', why:'Beginner-friendly content widens your funnel and captures early-stage prospects.' },
  ];
...
<div class="cover">
  <div class="cover-logo">WebinarIQ</div>
...
<div class="footer">WebinarIQ · Your Company · AI-Powered Webinar Intelligence · Confidential · ${new Date().toLocaleDateString('en-IN')}</div>
</body></html>`;
