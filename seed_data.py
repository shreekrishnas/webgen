...
def _seed_speakers_webinars(db):
    ...
    speakers_data = [
        {"name": "Anil Rego", "email": "anil.rego@company.com", "bio": "Certified professional with 18+ years of industry experience and deep domain expertise."},
        {"name": "Priya Sharma", "email": "priya.sharma@company.com", "bio": "Senior analyst and coach with extensive experience at top-tier firms."},
        {"name": "Rajesh Kumar", "email": "rajesh.kumar@company.com", "bio": "Certified consultant specialising in strategy and planning for high-value clients."},
        {"name": "Meera Nair", "email": "meera.nair@company.com", "bio": "Planning specialist and advisory firm founder with a focus on long-term outcomes."},
        {"name": "Vikram Patel", "email": "vikram.patel@company.com", "bio": "Research veteran and portfolio manager with 20 years of industry experience."},
        {"name": "Shakthi Prabhu", "email": "shakthi.prabhu@company.com", "bio": "Risk management specialist with expertise in comprehensive coverage and planning."},
    ]
    ...
    webinars_raw = [
        ...
        ("Investment Strategy for Wealth Building", date(2024, 3, 25), "2:00 PM", speakers[0], "Systematic investment strategies to grow wealth over time.", "completed"),
        ...
        ("Debt Management and Credit Score Mastery", date(2024, 10, 8), "3:00 PM", speakers[1], "How to manage debt effectively and improve your credit score.", "completed"),
        ...
        ("Income Tax Filing Made Easy", date(2024, 4, 22), "4:00 PM", speakers[2], "Step-by-step walkthrough for filing your tax return.", "completed"),
        ("Health Insurance Tax Benefits Explained", date(2024, 8, 20), "10:00 AM", speakers[2], "Maximising deductions and choosing the right health cover.", "completed"),
        ("Advanced Tax Strategies 2026", date(2026, 6, 10), "2:00 PM", speakers[2], "Advanced tax planning techniques for high-value clients and business owners.", "upcoming"),
        ...
        ("Long-term Savings Deep Dive", date(2024, 6, 18), "3:00 PM", speakers[3], "Comparing long-term savings instruments for wealth creation.", "completed"),
        ...
        ("Sectoral Outlook: Where to Invest in 2026", date(2026, 7, 1), "3:00 PM", speakers[4], "Top sector picks and macro themes for 2026.", "upcoming"),
        ...
        ("Health Insurance Deep Dive", date(2024, 8, 15), "2:00 PM", speakers[5], "Understanding riders, sub-limits, and choosing between individual vs family plans.", "completed"),
